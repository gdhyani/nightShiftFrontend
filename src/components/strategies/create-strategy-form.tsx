  ...
  return (
    <div>
      <button
        ...
        className="px-4 py-2 rounded-lg text-sm font-bold bg-primary-container text-on-primary transition-all duration-200 hover:brightness-110"
      >
        + New Strategy
      </button>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="rounded-xl p-5 space-y-4 bg-surface-container-lowest border border-outline-variant/10">
              <div>
